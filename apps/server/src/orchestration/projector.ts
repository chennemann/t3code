          ...
          todos: (nextBase.todos ?? []).map((todo) =>
            todo.id === payload.todoId
              ? {
                  ...
                  ...(payload.specificationSummary !== undefined ? { specificationSummary: payload.specificationSummary } : {}),
                  ...(payload.contextSummary !== undefined ? { contextSummary: payload.contextSummary } : {}),
                  ...(payload.glossarySummary !== undefined ? { glossarySummary: payload.glossarySummary } : {}),
                  ...
                  ...(payload.parentTodoId !== undefined ? { parentTodoId: payload.parentTodoId } : {}),
                  ...(payload.planningThreadId !== undefined ? { planningThreadId: payload.planningThreadId } : {}),
